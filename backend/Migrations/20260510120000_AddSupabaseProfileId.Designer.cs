...
namespace backend.Migrations
{
    ...
    [Migration("20260510120000_AddSupabaseProfileId")]
    partial class AddSupabaseProfileId
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("backend.Models.User", b =>
                {
                    ...
                    b.Property<string>("SupabaseProfileId")
                        .HasColumnType("TEXT")
                        .HasComment("Optional UUID from Supabase profiles.id for Cart's TV app integration");
